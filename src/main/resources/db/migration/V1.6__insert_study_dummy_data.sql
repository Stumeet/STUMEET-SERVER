...
INSERT INTO study (id, study_domain_id, name, region, intro, rule, image, meeting_time, meeting_repeat, start_date, end_date)
VALUES (1, 1, '[임시] 프로그래밍 스터디', '서울', '프로그래밍 스터디 입니다.', '- 매주 목요일 8시\n- 장소: 안암역\n- 제시간에 제출하기!',
        ...
        '21:00:00', 'WEEKLY;월요일;수요일;목요일;', '2024-04-01', '2024-05-01');
