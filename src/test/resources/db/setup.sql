...
-- 스터디 1 활동 (기본 활동)
INSERT INTO activity (id, study_id, author_id, category, title, content, is_notice, start_date, end_date, location)
VALUES (2, 1, 1, 'DEFAULT', 'title', 'content', false, '2024-04-01T00:00:00', '2050-05-01T00:00:00', null);
...
-- 스터디 1 활동 (모임 활동)
INSERT INTO activity (id, study_id, author_id, category, title, content, is_notice, start_date, end_date, location)
VALUES (3, 1, 1, 'MEET', 'title', 'content', false, '2024-04-01T00:00:00', '2050-05-01T00:00:00', '성신여대 카페구월');
...
-- 스터디 1 활동 (과제 활동)
INSERT INTO activity (id, study_id, author_id, category, title, content, is_notice, start_date, end_date, location)
VALUES (4, 1, 1, 'ASSIGNMENT', 'title', 'content', true, '2024-04-01T00:00:00', '2050-05-01T00:00:00', null);
...
INSERT INTO activity_participant (id, activity_id, member_id, status) VALUES (7, 4, 1, 'UNSUBMITTED');
INSERT INTO activity_participant (id, activity_id, member_id, status) VALUES (8, 4, 2, 'PERFORMED');

-- 스터디 2 활동 (기본 활동 - 공지)
INSERT INTO activity(id, study_id, author_id, category, title, content, is_notice, start_date, end_date, location)
VALUES (5, 2, 1, 'DEFAULT', 'title', 'content', true, '2024-04-01T00:00:00', '2050-05-01T00:00:00', null);

INSERT INTO activity_image (id, activity_id, image) VALUES (13, 5, 'https://example.com/images/image1.png');
INSERT INTO activity_image (id, activity_id, image) VALUES (14, 5, 'https://example.com/images/image2.png');
INSERT INTO activity_image (id, activity_id, image) VALUES (15, 5, 'https://example.com/images/image3.png');
INSERT INTO activity_participant (id, activity_id, member_id, status) VALUES (9, 5, 1, 'NONE');
INSERT INTO activity_participant (id, activity_id, member_id, status) VALUES (10, 5, 2, 'NONE');